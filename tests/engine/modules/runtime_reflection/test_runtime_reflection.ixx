...
namespace
{
	...
	struct tag_a : ge::refl::func_trait { int m_id{}; };
	struct tag_b : ge::refl::func_trait { std::string_view m_label{}; };
	struct tag_unused : ge::refl::func_trait {};
	struct tag_derived_a : tag_a {};
	struct type_tag : ge::refl::type_trait { int m_id{}; };
	struct data_tag : ge::refl::data_trait { int m_id{}; };
	...
	struct fixture_holder { int m_value{}; };
	...
	struct int_type_trait : ge::refl::type_trait { int payload{}; };
	struct int_func_trait : ge::refl::func_trait { int payload{}; };
	struct int_data_trait : ge::refl::data_trait { int payload{}; };
	struct string_type_trait : ge::refl::type_trait { std::string payload{}; };
	...
	{
		const ge::refl::type_data* found = std::ranges::find_if(reg.m_types,
