...
namespace
{
	void expect_tokens(std::string_view source, std::initializer_list<ge::token> expected,
...
namespace tokeniser
{
	...
	{
		expect_tokens("L\"w\" u8\"a\" u\"b\" U\"c\"",
			{
				{ "L\"w\"" },
				{ " ", ge::token::flag::white_space },
				{ "u8\"a\"" },
	...
	{
		expect_tokens("R\"(quote \" bracket })\" x",
			{
				{ "R\"(quote \" bracket })\"" },
				{ " ", ge::token::flag::white_space },
				{ "x", ge::token::flag::valid_identifier },
