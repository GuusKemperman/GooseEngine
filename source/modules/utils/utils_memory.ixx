...
namespace ge
{
	...
	struct in_place_delete
	{
		...
		constexpr in_place_delete( const in_place_delete< other_t >& ) noexcept
	...
	public:
		...
		constexpr ref_base( arg_t&&... a_arg )
			requires( std::is_constructible_v< ptr_t, arg_t... > );

		template< typename other_ptr_t >
		constexpr ref_base( const ref_base< other_ptr_t >& other )
			requires( std::is_constructible_v< ptr_t, const other_ptr_t& > );

		template< typename other_ptr_t >
		constexpr ref_base( ref_base< other_ptr_t >&& other ) noexcept
			requires( std::is_constructible_v< ptr_t, other_ptr_t && > );

		template< typename other_ptr_t >
		constexpr ref_base& operator=( const ref_base< other_ptr_t >& other )
			requires( std::is_assignable_v< ptr_t, const other_ptr_t& > );

		template< typename other_ptr_t >
		constexpr ref_base& operator=( ref_base< other_ptr_t >&& other ) noexcept
			requires( std::is_assignable_v< ptr_t, other_ptr_t && > );

		template< typename other_t >
		constexpr operator shared_ref< other_t >() const
			requires( std::is_convertible_v< const ptr_t&, typename shared_ref< other_t >::ptr_type > );
	...
	export template< typename T >
	class shared_ref : public ref_base< shared_ptr< T > >
	{
	public:
	...
	class unique_ref : public ref_base< unique_ptr< T, deleter_t > >
	{
	public:
	...
	shared_ptr< T > make_shared_ptr( args_t&&... args )
		requires( std::is_constructible_v< T, args_t... > );

	export template< typename T, typename... args_t >
	unique_ptr< T > make_unique_ptr( args_t&&... args )
		requires( std::is_constructible_v< T, args_t... > );

	export template< typename T, typename... args_t >
	shared_ref< T > make_shared_ref( args_t&&... args )
		requires( std::is_constructible_v< T, args_t... > );

	export template< typename T, typename... args_t >
	unique_ref< T > make_unique_ref( args_t&&... args )
		requires( std::is_constructible_v< T, args_t... > );
...
constexpr ge::ref_base< ptr_t >::ref_base( arg_t&&... a_arg )
	requires( std::is_constructible_v< ptr_t, arg_t... > )
...
template< typename ptr_t >
template< typename other_ptr_t >
constexpr ge::ref_base< ptr_t >::ref_base( const ref_base< other_ptr_t >& other )
	requires( std::is_constructible_v< ptr_t, const other_ptr_t& > )
	: m_ptr( other.get_ptr() )
{
}
...
template< typename ptr_t >
template< typename other_ptr_t >
constexpr ge::ref_base< ptr_t >::ref_base( ref_base< other_ptr_t >&& other ) noexcept
	requires( std::is_constructible_v< ptr_t, other_ptr_t && > )
...
template< typename ptr_t >
template< typename other_ptr_t >
constexpr ge::ref_base< ptr_t >& ge::ref_base< ptr_t >::operator=( const ref_base< other_ptr_t >& other )
	requires( std::is_assignable_v< ptr_t, const other_ptr_t& > )
{
	m_ptr = other.get_ptr();
	return *this;
...
template< typename ptr_t >
template< typename other_ptr_t >
constexpr ge::ref_base< ptr_t >& ge::ref_base< ptr_t >::operator=( ref_base< other_ptr_t >&& other ) noexcept
	requires( std::is_assignable_v< ptr_t, other_ptr_t && > )
{
	m_ptr = std::move( other ).get_ptr();
	return *this;
...
template< typename ptr_t >
template< typename other_t >
constexpr ge::ref_base< ptr_t >::operator ge::shared_ref< other_t >() const
	requires( std::is_convertible_v< const ptr_t&, typename shared_ref< other_t >::ptr_type > )
{
	return { *this };
}
...
ge::shared_ptr< T > ge::make_shared_ptr( args_t&&... args )
	requires( std::is_constructible_v< T, args_t... > )
{
...
template< typename T, typename... args_t >
ge::unique_ptr< T > ge::make_unique_ptr( args_t&&... args )
	requires( std::is_constructible_v< T, args_t... > )
{
...
template< typename T, typename... args_t >
ge::shared_ref< T > ge::make_shared_ref( args_t&&... args )
	requires( std::is_constructible_v< T, args_t... > )
{
...
template< typename T, typename... args_t >
ge::unique_ref< T > ge::make_unique_ref( args_t&&... args )
	requires( std::is_constructible_v< T, args_t... > )
{
